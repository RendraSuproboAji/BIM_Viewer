 ...
 *
 * web-ifc's schema tables are several MB, so this module is only used by the
 * IFC conversion worker and by `npm run gen:ifc-classes`, which writes the
 * discipline tables the viewer needs to ifc-disciplines.generated.ts.
 */
...
/** Class names per discipline group, as written to ifc-disciplines.generated.ts. */
export function disciplineTables() {
